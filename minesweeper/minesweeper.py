...
class Sentence:
    ...
    def assign_minesweeper(self, minesweeper):
        """
        Temporary storage of the Minesweeper instance for use in known_mines.
        """
        self.minesweeper_instance = minesweeper
...
class MinesweeperAI:
    ...
    def make_random_move(self):
        ...
        spaces_left = (self.height * self.width) - (
            len(self.moves_made) + len(self.mines)
        )
        ...
        if moves not in self.knowledge:
